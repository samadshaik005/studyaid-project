...
-->
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="admin_completedorders.php"><b style=" font-size: 20px;">Completed Orders</b></a>
...
<!--    </div>-->
    <div class="container" >
        ...
        <center>    <h2 style="padding-top:3%;padding-bottom:3%; font-family: 'Times New Roman', Times, serif;">Completed Orders</h2>
    </center>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $contact;?></td>
          ...
          <td>Completed</td>
         <td><a href="delete.php?id=<?php echo $id?>&pg=2"><button  type="button" class="login100-form-btn" style="padding: 6px 12px ;background:#F70F0F !important;" >
							Delete
						</button></a></td>
    </tr>
      <?php
